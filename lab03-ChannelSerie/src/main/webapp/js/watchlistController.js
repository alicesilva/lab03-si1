 ...
 * 
 */
app.controller("WatchlistController", function($scope, $http, $rootScope, $location){
    ...
    $scope.addSerieToProfile = function(name, year, image){
    	...
    	$http.post("admin/registerWatchlistSerieOnProfile/"+$rootScope.userLoggedIn.id, $scope.serieProfile)
